...
<div class="row" id="page-header"><img src="../_img/pghead-casestudy.jpg"  alt="market research case studies"/>
...
<div class="inside">
      ...
      <img src="../_img/len_rai_landing.jpg" alt="" width="643" height="347"/>
	<br>
	<ol>
	...
	<ul class="services">
		...
		<li>Brand Equity, A&U, Trackers</li>
		<li>Product & Packaging</li>
		<li>Advertising/Messaging</li>
		<li>Custom Segmentation</li>
		<li>Customer Satisfaction/Brand Health</li>
